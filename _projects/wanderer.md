...
play_url: /wanderer/
card_role: Direction and review; Codex-assisted implementation
project_overview:
...
<div class="project-lead-image row">
  <div class="col-sm mt-3 mt-md-0">
    {% include figure.liquid loading="eager" path="assets/img/projects/wanderer/wanderer-thumbnail.png" title="Wanderer gameplay" alt="Wanderer running the Shepherd Rings preset" class="img-fluid rounded z-depth-1" %}
  </div>
</div>
<div class="caption">
...
It is a browser-based physics toy built with JavaScript and Three.js. One small intervention can change a stable-looking system; watching what happens is the point of the sandbox.
